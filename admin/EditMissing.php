        ...
        <section class="addMissing" style="padding-top: 40px;">
            <div class="container">
                ...
                <ul class="tabs_titles">
                    ...
                    <li class="tab-button"> تأكيد البلاغ </li>
                ...
                <form class="addMissing_form tabs-content" id="edit_missing" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4">
                                <div class="form-group" id="radioSelect">
                                    <label for="wrfref"> جهة البلاغ </label>
                                    <div class="input-group mb-3">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio1" value="1">
                                            <label class="form-check-label" for="inlineRadio1"> مستشفي </label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio2" value="2">
                                            <label class="form-check-label" for="inlineRadio2">ملجئ</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio3" value="3">
                                            <label class="form-check-label" for="inlineRadio3">اقسام شرطة</label>
                                        </div>
                    ...
                    <div class="tab-content">
                        <div class="row">
                            ...
                            <label for="nationality" class="form-label"> تغيير حالة المفقود </label>
                            ...
                            <div class="col-lg-12 col-md-12 col-12">
                                <div class="form_group">
                                    ...
                                    <select class="form_input" id="relation" name="missing_status">
                                        ...
                                        <option value="0"> مفقود </option>

                                        <option value="1"> تم العثور عليه </option>
                        ...
                        <div class="row">
                            ...
                            <div class="form_btn text-center">
                                <button type="submit" class="white_hover col-lg-12" name="submit">تعديل البلاغ</button>
                            </div>
