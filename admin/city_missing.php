        ...
        <div class="row">
            ...
            <div class="col-lg-10">
                <div class="side-right">
                    <?php
                    if (isset($_GET["id"])) {
                        $city_code_id =  $_GET['id'];

                        $sel = $con->prepare("SELECT * FROM missing WHERE city_code=:city_code");
                        $sel->bindparam('city_code', $city_code_id);
                        $sel->execute();
                    ...
                    <div class="content-template">
                        <div class="upper-template">
                            <div class="template-title">
                                <h2 class="h1"> الاطفال المفقودة داخل المدن </h2>
                            </div>
