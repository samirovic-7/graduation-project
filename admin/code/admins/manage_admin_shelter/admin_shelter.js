...
function getAlladmins() {
    ...
    xml.open("get", "code/admins/manage_admin_shelter/select_admin_shelter.php", true);
...
function delete_admins(id) {
    ...
    let xml = new XMLHttpRequest;
    xml.open("post", "code/admins/manage_admin_shelter/delete_admin_shelter.php", true);
