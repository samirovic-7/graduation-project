...
function get_all_citizines()
{
    ...
    xml.open("get","code/citizine/activated_citizines/select_activated_citizines.php",true);
...
function not_activate(ssn)
{
    ...
    let xml = new XMLHttpRequest;
    xml.open("post","code/citizine/activated_citizines/not_activated.php",true);
