...
let select_governorate = document.getElementById("governorate_code");
...
specific_city_governorate.onchange=function()
{
    ...
    radioSelect.forEach(function(radioSelect)
    {
        radioSelect.onchange=function()
        {
            let departmentStatus = radioSelect.value;
...
$("#missingplace").on("submit",function(e)
{
    e.preventDefault();

    $.ajax({
        type:'POST',
        url: "code/missinplace/missingplace.php",
