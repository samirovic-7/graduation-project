...
<body>
                    ...
                    <div class="content-template">
                        <div class="upper-template">
                            ...
                            <div class="template-search">
                                ...
                                <div class="pos">
                                    <input type="text" class="form-control" placeholder="" id="ssn">
                            ...
                            <div class="add">
                                <button type="button" class="btn btn-primary" id="ssn_button"> إدخال الرقم القومي   </button>
    ...
    <script src="code/search_admin/search_admin.js"></script>
