...
<header>
                        ...
                        <ul>
                            ...
                            <?php if(!$user->checkLogin()):?>
                                <li class="user_log">
                                    ...
                                    <a href="login.php" class="nav_item active">تسجيل دخول</a>
                                </li><!-- ./user_log -->
                            <?php endif; ?>
                            <?php if($user->checkLogin()):?>
            ...
            <div class="container">
                <div class="sign_content">
                    ...
                    <div class="sign_content_inner">
                        ...
                        <h2 class="sign_title">تسجيل دخول لحسابك</h2>
                        <form action="login.php" method="post" id="login" class="sign_form">
                            <div class="success">
                            ...
                            <input type="text" required class="form_input" name="email" required id="email" placeholder="البريد الإلكتروني">
                            <label for="password">كلمة المرور</label>
                            <input type="password" required class="form_input" name="password" minlength="8" required id="password" placeholder="********">
                            <button class="white_hover sign_btn">دخول</button>
                        </form><!-- ./sign_form -->
                    ...
                    <div class="col-lg-9 col-md-8 col-12">
                        ...
                        <div class="footer_item">
                            <ul class="footer_list">
                                <li><a href="missing.php">الصفحة الرئيسية</a></li>
    ...
    <script src="front_code/registration/login.js"></script>
